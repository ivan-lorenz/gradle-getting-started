...
insert into event (id, name, description, venue_id, start, category, url_image) values(4, 'La Liga game', 'Madrid football game', 1, ' 2019-01-02 22:00:00','FOOTBALL_MATCH', 'https://images-na.ssl-images-amazon.com/images/I/61BWocKFkeL._SX425_.jpg');
...
insert into ticket_config (id, type, price, quantity, event_id) values(7, 'VIP', 100, 2000, 4);
insert into ticket_config (id, type, price, quantity, event_id) values(8, 'NORMAL', 50, 3000, 4);
