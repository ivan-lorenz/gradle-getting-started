...
insert into event (id, name, description, venue_id, start) values(3, 'La Liga game', 'Barcelona football game', 1, ' 2019-01-01');
insert into event (id, name, description, venue_id, start) values(4, 'La Liga game', 'Madrid football game', 2, ' 2019-01-02');
