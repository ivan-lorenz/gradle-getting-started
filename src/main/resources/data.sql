...
insert into event (id, name, description, venue_id, start, category, url_image) values(4, 'La Liga game', 'Madrid football game', 2, ' 2019-01-02 22:00:00','FOOTBALL_MATCH', 'https://image.shutterstock.com/image-photo/barcelona-january-25-panoramic-view-450w-93599314.jpg');
